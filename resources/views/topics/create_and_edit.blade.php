    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="relpy_count-field">Relpy_count</label>
                    <input class="form-control" type="text" name="relpy_count" id="relpy_count-field" value="{{ old('relpy_count', $topic->relpy_count ) }}" />
                </div> 
                <div class="form-group">
